...
def get_object_pc_fp():
    ...
    arm_right_cam_K_path = Path(f"third_party/xarm6/data/camera/{arm_right_cam_serial}/K.npy")
    arm_right_cam_K = np.load(arm_right_cam_K_path)
    arm_right_cam_X_BaseCamera_path = Path(f"third_party/xarm6/data/camera/{arm_right_cam_serial}/1113_excalib_capture02/optimized_X_BaseCamera.npy")
