...
socket.connect("tcp://172.25.109.87:5555")
...
# for i in range(20):
    ...
    arm.set_position(x=xarm_target_pose[0], y=xarm_target_pose[1], z=xarm_target_pose[2], roll=-180, pitch=0, yaw=0, speed=speed, wait=False)
