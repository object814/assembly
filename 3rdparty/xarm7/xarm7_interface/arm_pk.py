...
from xarm7_interface import XARM7_WO_EE_URDF_PATH
from xarm7_interface.utils import (
...
class RobotArm:
    ...
    def __init__(
        ...
        self.joint_start_idx = 7 if self.have_dummy_joints else 0
        ...
        print("Actuated joint names:", self.actuated_joint_names)
        print("Number of DOF:", self.ndof)
        # bp()
...
class XArm7WOEE(RobotArm):
    def __init__(
        self,
        urdf_path: Path = XARM7_WO_EE_URDF_PATH,
        load_visual_mesh: bool = True,
        load_col_mesh: bool = True,
        dtype=torch.float,
        device="cuda",
