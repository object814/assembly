...
from xarm7_interface.arm_mplib import min_jerk_interpolator_with_alpha 
from scipy.spatial.transform import Rotation as R

class XArm7RealWorld:
    def __init__(self, ip=XARM7LEFT_IP,is_radian=True, default_speed=0.5):
