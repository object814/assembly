...
def get_object_pc_fp(object_name, arm_ip=XARM6_IP):
    ...
    if arm_ip == XARM6LEFT_IP:
        ...
        for camera_idx in range(len(rtr_dict_list)):
            ...
            points = sample_points_from_mesh(mesh, 1000)
...
def insert(arm_ip=XARM6_IP):
    ...
    canonical_pcd1, mat1, center1 = canonicalize_point_cloud(rw_pcd1)
    ...
    sv.scene.add_point_cloud("canon_pc2",points = np.asarray(canonicalized_pcd.points),colors=(0,255,255),point_size=0.002,point_shape="circle")
